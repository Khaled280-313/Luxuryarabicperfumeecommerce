...
export default function ProductDetailContent({ product, reviews, relatedProducts }: ProductDetailContentProps) {
                        ...
                        <div className="grid grid-cols-4 gap-3">
                            {product.images.map((image, index) => (
                                <button
                                    ...
                                    className={`aspect-square rounded overflow-hidden border-2 transition-colors ${selectedImage === index ? 'border-primary' : 'border-transparent'
                                        }`}
                                >
                    ...
                    <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-3 mb-4">
                                <div className="flex items-center gap-1">
                                    {[...Array(5)].map((_, i) => (
                                        <Star
                                            key={i}
                                            className={`w-5 h-5 ${i < Math.floor(product.rating) ? 'text-primary fill-current' : 'text-muted'
                                                }`}
                                        />
                                    ))}
                                </div>
                            ...
                            <div className="flex gap-3">
                                {product.size.map((size) => (
                                    <button
                                        ...
                                        className={`px-6 py-3 rounded-lg border transition-colors ${selectedSize === size
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className={`w-14 h-14 rounded-lg flex items-center justify-center transition-all hover:scale-105 ${isInWishlist(product.id)
                        ...
                        <div className="flex gap-8">
                            {[
                                ...
                                <button
                                    ...
                                    className={`pb-4 font-medium transition-colors relative ${activeTab === tab.key ? 'text-primary' : 'text-muted-foreground hover:text-foreground'
                                        }`}
                                >
                                    {tab.label}
                                    {activeTab === tab.key && (
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <div className="flex gap-1">
                                                            {[...Array(5)].map((_, i) => (
                                                                <Star
                                                                    key={i}
                                                                    className={`w-4 h-4 ${i < review.rating ? 'text-primary fill-current' : 'text-muted'
                                                                        }`}
                                                                />
                                                            ))}
                                                        </div>
