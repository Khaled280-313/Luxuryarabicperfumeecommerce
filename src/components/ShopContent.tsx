...
export default function ShopContent({ initialProducts }: ShopContentProps) {
    ...
    const filteredAndSortedProducts = useMemo(() => {
        ...
        return filtered;
    }, [selectedCategory, selectedFragrance, selectedBrand, priceRange, showLimitedOnly, sortBy, products]);
                    ...
                    <AnimatePresence>
                        {(showFilters || isDesktop) && (
                            <motion.aside
                                ...
                                exit={{ opacity: 0, x: 20 }}
                                className={`${showFilters ? 'fixed' : 'hidden'
                                            ...
                                            <div className="space-y-2">
                                                {[
                                                    ...
                                                    <button
                                                        ...
                                                        className={`w-full text-right px-3 py-2 rounded transition-colors ${selectedCategory === cat.value
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                <button
                                                    ...
                                                    className={`w-full text-right px-3 py-2 rounded transition-colors ${selectedFragrance === 'all'
                                                            ? 'bg-primary/10 text-primary'
                                                            : 'hover:bg-secondary'
                                                        }`}
                                                >
                                                ...
                                                {fragranceTypes.map((type) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-right px-3 py-2 rounded transition-colors ${selectedFragrance === type.value
                                                                ? 'bg-primary/10 text-primary'
                                                                : 'hover:bg-secondary'
                                                            }`}
                                                    >
                                        ...
                                        <div>
                                            ...
                                            <div className="space-y-2">
                                                <button
                                                    ...
                                                    className={`w-full text-right px-3 py-2 rounded transition-colors ${selectedBrand === 'all'
                                                            ? 'bg-primary/10 text-primary'
                                                            : 'hover:bg-secondary'
                                                        }`}
                                                >
                                                ...
                                                {brands.map((brand) => (
                                                    <button
                                                        ...
                                                        className={`w-full text-right px-3 py-2 rounded transition-colors ${selectedBrand === brand
                                                                ? 'bg-primary/10 text-primary'
                                                                : 'hover:bg-secondary'
                                                            }`}
                                                    >
